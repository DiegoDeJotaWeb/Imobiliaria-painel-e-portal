...
<div class="row">
	...
	<div align="right" class="col-md-2">
		<small><i class="fa fa-usd text-danger"></i> <span class="text-dark">Total: <span class="text-danger" id="total_itens">R$ 75.079,97</span></span></small>
	</div>
</div>
					...
					<div class="row">
						...
						<div class="col-md-4">						
							<div class="form-group"> 
								...
								<select class="form-control sel2 select2-hidden-accessible" name="pessoa" id="pessoa" style="width:100%;" data-select2-id="select2-data-pessoa" tabindex="-1" aria-hidden="true"> 

									<option value="" data-select2-id="select2-data-2-6wra">Selecionar Proprietário</option>
								...
								</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-1-87qp" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-pessoa-container" aria-controls="select2-pessoa-container"><span class="select2-selection__rendered" id="select2-pessoa-container" role="textbox" aria-readonly="true" title="Selecionar Proprietário">Selecionar Proprietário</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
							</div>						
						</div>
						...
						<div class="col-md-4">						
							<div class="form-group"> 
								...
								<select class="form-control sel2 select2-hidden-accessible" name="locatario" id="locatario" style="width:100%;" data-select2-id="select2-data-locatario" tabindex="-1" aria-hidden="true"> 
									...
									<option value="" data-select2-id="select2-data-4-5ks9">Selecionar Inquilino</option>
								...
								</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-3-ukpt" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-locatario-container" aria-controls="select2-locatario-container"><span class="select2-selection__rendered" id="select2-locatario-container" role="textbox" aria-readonly="true" title="Selecionar Inquilino">Selecionar Inquilino</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
							</div>						
						</div>
						...
						<div class="col-md-4">						
							<div class="form-group"> 
								...
								<select class="form-control sel2 select2-hidden-accessible" name="corretor" id="corretor" style="width:100%;" data-select2-id="select2-data-corretor" tabindex="-1" aria-hidden="true"> 

									<option value="" data-select2-id="select2-data-6-pwst">Selecionar Corretor</option>

										
										<option value="16">Arthur - 093.000.000-00</option>

										
										<option value="9">Corretor Teste - 844.444.444-44</option>

										
										<option value="13">Fábio - 090.000.000-00</option>

										
										<option value="11">Katia Silva - 787.878.454-54</option>

										
										<option value="15">Pedro - 092.000.000-00</option>

										
										<option value="14">Wanderley - 091.000.000-00</option>

									
								</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-5-ofhg" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-corretor-container" aria-controls="select2-corretor-container"><span class="select2-selection__rendered" id="select2-corretor-container" role="textbox" aria-readonly="true" title="Selecionar Corretor">Selecionar Corretor</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
							</div>						
						</div>
						...
						<div class="col-md-4">						
							<div class="form-group"> 
								...
								<select class="form-control sel2 select2-hidden-accessible" name="frequencia" id="frequencia" required="" style="width:100%;" data-select2-id="select2-data-frequencia" tabindex="-1" aria-hidden="true"> 
										...
										<option value="0" data-select2-id="select2-data-8-jmgw">Uma Vez</option>
								...
								</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-7-xe9w" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-frequencia-container" aria-controls="select2-frequencia-container"><span class="select2-selection__rendered" id="select2-frequencia-container" role="textbox" aria-readonly="true" title="Uma Vez">Uma Vez</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
							</div>						
						</div>
						...
						<div class="col-md-4">						
							<div class="form-group"> 
								...
								<select class="form-control sel2 select2-hidden-accessible" name="saida" id="saida" style="width:100%;" data-select2-id="select2-data-saida" tabindex="-1" aria-hidden="true"> 
									...
									<option value="Caixa" data-select2-id="select2-data-10-bwka">Caixa</option>
								...
								</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-9-nb3t" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-saida-container" aria-controls="select2-saida-container"><span class="select2-selection__rendered" id="select2-saida-container" role="textbox" aria-readonly="true" title="Caixa">Caixa</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
							</div>						
						</div>
...
<div class="modal fade" id="modalParcelar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							...
							<div class="form-group"> 
								...
								<select class="form-control sel3 select2-hidden-accessible" name="frequencia" id="frequencia-parcelar" required="" style="width:100%;" data-select2-id="select2-data-frequencia-parcelar" tabindex="-1" aria-hidden="true">
																				...
																				<option value="1">Diária</option>
																					...
																					<option selected="" value="30" data-select2-id="select2-data-12-whmo">Mensal</option>

										

									</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-11-wumj" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-frequencia-parcelar-container" aria-controls="select2-frequencia-parcelar-container"><span class="select2-selection__rendered" id="select2-frequencia-parcelar-container" role="textbox" aria-readonly="true" title="Mensal">Mensal</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group"> 
									...
									<select class="form-control sel4 select2-hidden-accessible" name="saida-baixar" id="saida-baixar" required="" style="width:100%;" data-select2-id="select2-data-saida-baixar" tabindex="-1" aria-hidden="true">
										<option value="Caixa" data-select2-id="select2-data-14-trel">Caixa (Movimento)</option>
										<option value="Cartão de Débito">Cartão de Débito</option>
										<option value="Cartão de Crédito">Cartão de Crédito</option>
									...
									</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-13-ra94" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-saida-baixar-container" aria-controls="select2-saida-baixar-container"><span class="select2-selection__rendered" id="select2-saida-baixar-container" role="textbox" aria-readonly="true" title="Caixa (Movimento)">Caixa (Movimento)</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
								</div>
							</div>
	...
	<div class="modal fade" id="modalArquivos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		...
		<script type="text/javascript">var pag = "pagar"</script>
