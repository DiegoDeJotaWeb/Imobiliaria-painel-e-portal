...
<div id="page-wrapper">
    ...
    ?>
    <div class="tables">
        <h2 class="title1"><button type="button" class="btn btn-success btn-flat btn-pri" data-toggle="modal" data-target="#modalInserir" data-whatever="@mdo"><i class="fa fa-plus" aria-hidden="true"></i> NOVO VENDEDOR / LOCADOR</button></h2>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="exampleModalLabel">Inserir vendedor / locador</h4>
                </div>
                <div class="modal-body">
                    <form action="vendor/functions/pessoas/funcionario.php" method="POST" enctype='multipart/form-data'>
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="fisicaJuridica" class="control-label">Física / Jurídica:</label>
                                    <select class="form-control" id="fisicaJuridica" name="fisicaJuridica">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="cpfFuncionario" class="control-label">CPF / CNPJ:</label>
                                    <input type="text" class="form-control" id="cpfCnpjVendedorLo" name="cpfFuncionario" onkeypress="mascarat(this, '###.###.###-##')" maxlength="14">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="cpfFuncionario" class="control-label">Estado Cívil:</label>
                                    <input type="text" class="form-control" id="cpfCnpjVendedorLo" name="cpfFuncionario" onkeypress="mascarat(this, '###.###.###-##')" maxlength="14">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="" class="control-label">Data Nascimento:</label>
                                    <input type="date" class="form-control" id="" name="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="" class="control-label">Nacionalidade:</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" name="" onkeypress="mascarat(this, '###.###.###-##')" maxlength="14">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" class="control-label">Corretor:</label>
                                    <select class="form-control" id="cargoFuncionario" name="cargoFuncionario">
                                        <option value=""></option>
                                    <?php
                                        $query1 = $pdo->query("select nomeFuncionario from funcionarios where cargoFuncionario = 'Corretor'");
                                        while ($linha1 = $query1->fetch(PDO::FETCH_ASSOC)) {
                                            echo   "<option ='{$linha1['nomeFuncionario']}'>{$linha1['nomeFuncionario']}</option>";
                                        }
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" class="control-label">Profissão:</label>
                                    <input type="text" class="form-control" id="" name="">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="" class="control-label">Chave Pix:</label>
                                    <input type="text" class="form-control" id="" name="">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="" class="control-label">OBS (Max 500 Caracteres):</label>
                                    <div>
                                        <textarea style="width: 100%; height: 100px;" name="" id=""></textarea><br>
